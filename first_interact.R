...
ggsave("D://abortion40/ab1_both.png", ab1b, width = 12, height = 12)

ab2b <- ab2m + ab2f +plot_layout(ncol = 1)
ggsave("D://abortion40/ab2_both.png", ab2b, width = 12, height = 12)

ab3b <- ab3m + ab3f +plot_layout(ncol = 1)
ggsave("D://abortion40/ab3_both.png", ab3b, width = 12, height = 12)

ab4b <- ab4m + ab4f +plot_layout(ncol = 1)
ggsave("D://abortion40/ab4_both.png", ab4b, width = 12, height = 12)

ab5b <- ab5m + ab5f +plot_layout(ncol = 1)
ggsave("D://abortion40/ab5_both.png", ab5b, width = 12, height = 12)

ab6b <- ab6m + ab6f +plot_layout(ncol = 1)
ggsave("D://abortion40/ab6_both.png", ab5b, width = 12, height = 12)
