...
graph %>%
  ...
  ggsave("D://abortion40/images/democrat_5questions_males_ppt.png", type = "cairo-png", width = 10)
...
graph %>%
  ...
  theme(legend.position = "bottom") +  
  theme(legend.title=element_blank()) +
  ggsave("D://abortion40/images/democrat_5questions_females_ppt.png", type = "cairo-png", width = 10)
