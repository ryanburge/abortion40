...
gg2 +
  ...
  ggsave("D://abortion40/fina_images/interact_matterofchoice.png", type = "cairo-png", width = 10)
...
gg2 +
  ...
  theme(legend.position = c(.15,.15)) +
  theme(plot.title = element_text(size = 18)) +
  ggsave("D://abortion40/final_images/interact_illegal.png", type = "cairo-png", width = 10)